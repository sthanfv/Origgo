...
8. **Arquitectura de Componentes Tipados:** Componentes modulares en `src/components/` con estricta paridad visual respecto a producción (DirectPillarsSection, BentoGrid, CommandBar, SiteHeader, SiteHero, SiteFooter con Modo Visual).
9. **Estética Glassmorphic & Cambio Instantáneo de Modo Visual:** Conmutación de tema claro/oscuro de un solo golpe (0ms delay), Bento Grid de alta fidelidad, carruseles táctiles y modal de checkout nativo sin saltos.
