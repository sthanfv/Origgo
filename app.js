...
const DICCIONARIO_I18N = {
  es: {
    ...
    card_unlock_btn: 'Desbloquear', card_unlock_closed: 'Ver Cierre', card_unlocked_badge: 'Desbloqueado', card_view_ad: 'Ver Anuncio',
    ...
    checkout_btn_pay: 'Continuar al Pago Seguro con Wompi', checkout_btn_pay_default: 'Pagar con Wompi', checkout_btn_wompi_note: 'Bancolombia, Nequi, PSE, Tarjeta Crédito/Débito', checkout_merchant_title: 'Operador de Cobro Oficial:', checkout_merchant_desc: 'Tu pago se procesa de forma segura a través de Wompi Bancolombia a nombre de nuestro comercio operador registrado Desmulta.', checkout_guarantee_wompi: 'Pasarela Segura Wompi (Vigilada SFC)', checkout_guarantee_instant: 'Activación Instantánea',
  ...
  en: {
    ...
    card_unlock_btn: 'Unlock', card_unlock_closed: 'View Closed', card_unlocked_badge: 'Unlocked', card_view_ad: 'View Listing',
    ...
    checkout_btn_pay: 'Proceed to Secure Payment with Wompi', checkout_btn_pay_default: 'Pay with Wompi', checkout_btn_wompi_note: 'Bancolombia, Nequi, PSE, Credit & Debit Cards', checkout_merchant_title: 'Official Billing Merchant:', checkout_merchant_desc: 'Your payment is securely processed through Wompi Bancolombia under our authorized registered merchant Desmulta.', checkout_guarantee_wompi: 'Regulated Wompi Gateway (SFC Monitored)', checkout_guarantee_instant: 'Instant Activation',
