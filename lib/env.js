...
/** Variables de servicios externos que las pruebas no deben cargar desde .env. */
      ...
      content.split('\n').forEach(line => {
        ...
        if (trimmed && !trimmed.startsWith('#')) {
          ...
          if (idx !== -1) {
            ...
            // Las pruebas NUNCA reciben credenciales de servicios reales (Upstash, Firebase, Wompi,
            // Resend, Telegram…): el 2026-09-26 una prueba escribió precios de prueba en la caché
            // de producción de Upstash. Con NODE_ENV=test se usan los valores de prueba.
