...
/** Aviso de seguridad: se entró al panel con código por correo. */
async function avisarIngresoPorCorreo(admin, req) {
  ...
  await enviarCorreo({
    para: admin.email,
    asunto: 'Aviso: se entró al panel de Origgo con código por correo',
    html: plantilla(
