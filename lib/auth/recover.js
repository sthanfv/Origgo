...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // 5. Configurar remitente interno institucional con dominio verificado
    const remitenteInterno = (process.env.RESEND_FROM_EMAIL || 'Origgo Seguridad <seguridad@origgo.online>').trim();
